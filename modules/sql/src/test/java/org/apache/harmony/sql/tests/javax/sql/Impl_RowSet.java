...
class Impl_RowSet implements RowSet {
	...
	public void setBlob(int parameterIndex, InputStream theInputStream, long length) throws SQLException {
	...
	public void setBlob(String parameterName, InputStream theInputStream, long length) throws SQLException {
	...
	public void setCharacterStream(String parameterName, Reader theReader, int length) throws SQLException {
	...
	public void setNCharacterStream(int parameterIndex, Reader theReader, long length) throws SQLException {
	...
	public void setNCharacterStream(String parameterName, Reader theReader, long length) throws SQLException {
	...
	public void setTimestamp(String parameterName, Timestamp theTimestamp, Calendar theCalendar) throws SQLException {
