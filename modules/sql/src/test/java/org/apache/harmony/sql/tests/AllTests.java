...
package org.apache.harmony.sql.tests;
...
public class AllTests {
	...
	public static Test suite() {
		...
		suite.addTest(org.apache.harmony.sql.tests.javax.transaction.AllTests.suite());
		suite.addTest(org.apache.harmony.sql.tests.javax.transaction.xa.AllTests.suite());
		// $JUnit-END$
		return suite;
	}
}
