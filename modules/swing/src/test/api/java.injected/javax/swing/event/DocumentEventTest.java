...
public class DocumentEventTest extends BasicSwingTestCase {
    public DocumentEventTest(final String name) {
        super(name);
    }
    ...
    public void testEventType() throws Exception {
        ...
        assertEquals("CHANGE", DocumentEvent.EventType.CHANGE.toString());
    }
}
