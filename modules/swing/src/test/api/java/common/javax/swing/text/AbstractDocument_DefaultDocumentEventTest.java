 ...
 *
 */
public class AbstractDocument_DefaultDocumentEventTest extends TestCase
    ...
    public void testAddEdit01() throws BadLocationException {
        ...
        DefaultDocumentEvent edit =
            doc.new DefaultDocumentEvent(0, 10, DocumentEvent.EventType.CHANGE);
    ...
    public void testAddEdit02() {
        ...
        DefaultDocumentEvent edit =
            doc.new DefaultDocumentEvent(0, 10, EventType.CHANGE);

        Parent[] parent = new Parent[15];
        Child[]  child  = new Child[parent.length];
        for (int i = 0; i < parent.length; i++) {
            assertTrue("Can't add edit at " + i, edit.addEdit(child[i] =
                new Child(parent[i] = new Parent())));
    ...
    public void testUndo02() throws BadLocationException {
        final class UndoPlainDocument extends PlainDocument {
            ...
            protected void insertUpdate(final DefaultDocumentEvent event,
                ...
                insert = event;
                super.insertUpdate(event, attrs);
                event.addEdit(new ElementEdit(altRoot, 0,
        ...
        ElementChange change =
            insert.getChange(((UndoPlainDocument)doc).altRoot);
    ...
    public void testDefaultDocumentEvent() {
        DefaultDocumentEvent event =
            doc.new DefaultDocumentEvent(10, 7, DocumentEvent.EventType.CHANGE);
    ...
    public void testGetChange() {
        assertTrue(insert.getChange(doc.getBidiRootElement())
                   instanceof ElementEdit);
