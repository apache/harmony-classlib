...
public class JTreeTest extends BasicSwingTestCase {
    ...
    public void testGetSetModel() {
        ...
        DefaultTreeModel newModel = new DefaultTreeModel(new DefaultMutableTreeNode("some root"));
    ...
    public void testSetSelectionModel() {
        ...
        assertSame(mapper, tree.getSelectionModel().getRowMapper());
        assertTrue(propertyChangeController.isChanged("selectionModel"));
        propertyChangeController.checkPropertyFired(tree, "selectionModel", oldModel, tree.getSelectionModel());
    ...
    public void testGetPreferredScrollableViewportSize() {
        ...
        tree.setCellRenderer(new DefaultTreeCellRenderer() {
            public Component getTreeCellRendererComponent(final JTree tree,
                ...
                JComponent result = (JComponent)super.getTreeCellRendererComponent(tree, value, selected, expanded, leaf, row, hasFocus);
    ...
    public void testGetScrollableBlockIncrement() {
        assertEquals(30, tree.getScrollableBlockIncrement(new Rectangle(10, 20, 30, 40),  SwingConstants.HORIZONTAL, 1));
        assertEquals(30, tree.getScrollableBlockIncrement(new Rectangle(10, 20, 30, 40),  SwingConstants.HORIZONTAL, -1));

        assertEquals(40, tree.getScrollableBlockIncrement(new Rectangle(10, 20, 30, 40),  SwingConstants.VERTICAL, 1));
        assertEquals(40, tree.getScrollableBlockIncrement(new Rectangle(10, 20, 30, 40),  SwingConstants.VERTICAL, -1));
    }

    public void testGetScrollableUnitIncrement() {
        assertEquals(4, tree.getScrollableUnitIncrement(new Rectangle(10, 20, 30, 40),  SwingConstants.HORIZONTAL, 1));
        assertEquals(4, tree.getScrollableUnitIncrement(new Rectangle(100, 200, 300, 400),  SwingConstants.HORIZONTAL, -1));

        assertEquals(8, tree.getScrollableUnitIncrement(new Rectangle(10, 10, 30, 40),  SwingConstants.VERTICAL, 1));
        assertEquals(10, tree.getScrollableUnitIncrement(new Rectangle(10, 10, 30, 40),  SwingConstants.VERTICAL, -1));

        assertEquals(16, tree.getScrollableUnitIncrement(new Rectangle(10, 20, 30, 40),  SwingConstants.VERTICAL, 1));
        assertEquals(2, tree.getScrollableUnitIncrement(new Rectangle(10, 20, 30, 40),  SwingConstants.VERTICAL, -1));

        assertEquals(-128, tree.getScrollableUnitIncrement(new Rectangle(10, 200, 30, 40),  SwingConstants.VERTICAL, 1));
        assertEquals(146, tree.getScrollableUnitIncrement(new Rectangle(10, 200, 30, 40),  SwingConstants.VERTICAL, -1));

        tree.setModel(null);
        assertEquals(0, tree.getScrollableUnitIncrement(new Rectangle(10, 200, 30, 40),  SwingConstants.VERTICAL, 1));
        assertEquals(4, tree.getScrollableUnitIncrement(new Rectangle(10, 200, 30, 40),  SwingConstants.HORIZONTAL, 1));
    }
    ...
    private void checkInEnumeration(final Enumeration e, final Object[] expected) {
        assertNotNull(e);
    ...
    private Enumeration createTestEnumeration(final Object[] base) {
