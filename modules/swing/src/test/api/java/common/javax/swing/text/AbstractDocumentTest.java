...
public class AbstractDocumentTest extends TestCase {
    ...
    protected static class DisAbstractedDocument extends AbstractDocument {
        ...
        public DisAbstractedDocument(final Content content,
        ...
        protected void createRoot() {
            ...
            defRoot.replace(0, 0, new Element[] {
                    new LeafElement(defRoot, null, 0, 1)
                });
            writeUnlock();
        }
    ...
    public void testAbstractDocumentContentAttributeContext() {
        ...
        Object BidiProperty = BasicSwingTestCase.isHarmony() ?
                StringConstants.BIDI_PROPERTY : "i18n";
    ...
    public void testAbstractDocumentContent() {
        ...
        assertSame(content, doc.getContent());
        assertSame(StyleContext.getDefaultStyleContext(),
                doc.getAttributeContext());
    }

    public void testBAD_LOCATION() {
        assertEquals("document location failure",
