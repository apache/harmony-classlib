...
public class AbstractDocument_FilterTest extends TestCase {
    ...
    static class Filter extends DocumentFilter implements Serializable {
        ...
        public void insertString(final FilterBypass fb,
            ...
            if (str == "234") {
                ...
                super.insertString(fb, fb.getDocument().getLength(),
                                   "b", attrs);
                return;
            }
        ...
        public void replace(final FilterBypass fb, int offset, int len,
                            String str,
                            final AttributeSet attrs)
            throws BadLocationException {
    ...
    private static class EmptyFilter extends DocumentFilter {
        ...
        public void check(final boolean eInsert,
                          final boolean eRemove,
                          final boolean eReplace) {
            if (eInsert) {
