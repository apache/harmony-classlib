...
public class AbstractDocument_SerializationTest extends SerializableTestCase {
    ...
    public void testSerializable() throws BadLocationException {
        ...
        assertEquals(Boolean.TRUE,
                     restored.getProperty(BasicSwingTestCase.isHarmony()
                                          ? StringConstants.BIDI_PROPERTY
                                          : "i18n"));

        if (BasicSwingTestCase.isHarmony()) {
            AbstractDocument_ListenerTest listener =
                new AbstractDocument_ListenerTest();
            ...
            assertEquals("12345" + text,
                         restored.getText(0, restored.getLength()));
            ...
            assertEquals(restored.getLength() + 1,
                         restored.getEndPosition().getOffset());
