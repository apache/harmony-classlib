		...
		try {
			try {
				objToSave = new URI[] {
    					...
    					// unicode chars equivalent to = new URI("ascheme://userß£info@host:0/a€path?qu©®ery#fräèg"),
						...
						new URI("ascheme", "user\u00DF\u00A3info", "host", 80,
								"/a\u20ACpath", "qu\u00A9\u00AEery",
								"fr\u00E4\u00E8g"),
						// unicode chars equivalent to = new URI("ascheme", "userß£info",
						// "host", 80, "/a€path", "qu©®ery", "fräèg"),
