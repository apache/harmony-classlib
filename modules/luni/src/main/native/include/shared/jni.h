 ...
 */
  ...
  struct JavaVM_
  {
    ...
    jint AttachCurrentThread (void **p_env, void *args)
    {
      return functions->AttachCurrentThread (this, p_env, args);
    }
    ...
    jint AttachCurrentThreadAsDaemon (void **p_env, void *args)
    {
      return functions->AttachCurrentThreadAsDaemon (this, p_env, args);
    }
#endif
  };
  ...
  struct JVMExtensionInterface_
  {
    ...
    JavaVM *vm;
      ...
      jint (JNICALL * QueryJavaVM) (JavaVM * vm, jint nQueries,
                                    JavaVMQuery * queries);
      jint (JNICALL * QueryGCStatus) (JavaVM * vm, jint * nheaps,
                                      GCStatus * status, jint statusSize);
  };
  ...
  struct JVMExt_
  {
    ...
    jint ResetJavaVM ()
    {
      return functions->ResetJavaVM (functions->vm);
    }
    jint QueryJavaVM (jint nQueries, JavaVMQuery * queries)
    {
      return functions->QueryJavaVM (functions->vm, nQueries, queries);
    }
    jint QueryGCStatus (jint * nheaps, GCStatus * status, jint statusSize)
    {
      return functions->QueryGCStatus (functions->vm, nheaps, status,
                                       statusSize);
    }
#endif
  };
