...
public class DefaultPolicy extends Policy {
	...
	private void parseGrant(PolicyTokenizer parser, URL source,
		...
		while (!parser.isAtEOF()) {
			...
			if (parser.sval.equalsIgnoreCase("codeBase")) {
				if (parser.nextToken() != PolicyTokenizer.TOK_QUOTEDSTRING) {
					 ...
					 * {1}, found unquoted: {2}"]
					 */
					System.out.println(org.apache.harmony.luni.util.Msg.getString("K00a2",
				 ...
				 * {1}"]
				 */
				System.out.println(org.apache.harmony.luni.util.Msg.getString("K00a3",
						source, parser.sval));
				invalidGrant = true;
				break;
			}
		...
		try {
			 ...
			 * {1}"]
			 */
			System.out.println(org.apache.harmony.luni.util.Msg.getString("K00a8", source,
					codeBase));
		}
		if (invalidGrant) {
