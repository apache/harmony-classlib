...
public class IBM_Thai extends Charset {

        public IBM_Thai(String csName, String[] aliases) {
            super(csName, aliases);
        }

        public boolean contains(Charset cs) {
            return cs.name().equalsIgnoreCase("IBM-Thai") || cs.name().equalsIgnoreCase("IBM367") || cs.name().equalsIgnoreCase("US-ASCII") ;
        }
	...
	private static final class Encoder extends CharsetEncoder{
		...
		protected CoderResult encodeLoop(CharBuffer cb, ByteBuffer bb){
			...
			return CoderResult.UNDERFLOW;
                ...
                0xDB,0xDC,0xDD,0xDE,0xDF,0xEA,0xEB,0xEC,0xED,0xEE,0xEF,0xFD,0xFE,0xFC,0x71,0x80,
