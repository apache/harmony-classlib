...
public class TestCipherAllBouncyCastle extends TestCase {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite("BouncyCastleCipherAllTests");
        AllTransformation t = new AllTransformation("Cipher","BC");
