...
public class TestCipherAllCryptix extends TestCase {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(TestCipherAllCryptix.suite());
    }
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite("CryptixCryptoCipherAllTests");
        AllTransformation t = new AllTransformation("Cipher","CryptixCrypto");
        // BlockTransformation t = new BlockTransformation("Cipher");
        TestSuiteAcumulable suiteToRepeat = new TestSuiteAcumulable(TestCipherDinamic.class);
        while (t.hasNext()) {
            ...
            suite.addTest(new CipherTestSetup(suiteToRepeat, t));
        }
        return suite;
    }
