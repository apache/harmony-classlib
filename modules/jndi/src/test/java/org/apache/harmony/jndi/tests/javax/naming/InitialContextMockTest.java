...
public class InitialContextMockTest extends TestCase {
	...
	public void testAddToEnvironment() throws NamingException {
		...
		assertEquals("org.apache.harmony.jndi.tests.javax.naming.spi.mock.MockContextFactory", value);
	...
	public void testRemoveFromEnvironment() throws NamingException {
		...
		assertEquals("org.apache.harmony.jndi.tests.javax.naming.spi.mock.MockContextFactory", gContext
