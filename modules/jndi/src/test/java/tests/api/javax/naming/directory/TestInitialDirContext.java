...
public class TestInitialDirContext extends TestCase {

	static Log log = new Log(TestInitialDirContext.class);
	...
	/**
	 * Constructor for TestInitialDirContext.
	 * 
	 * @param arg0
	 */
	public TestInitialDirContext(String arg0) {
		super(arg0);
	}
	...
	protected void setUp() throws Exception {
		...
		env.put(Context.INITIAL_CONTEXT_FACTORY,
				"tests.api.javax.naming.mock.MockDirContextFactory");
