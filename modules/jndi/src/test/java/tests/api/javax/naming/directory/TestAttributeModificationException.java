...
public class TestAttributeModificationException extends TestCase {

	private static Log log = new Log(TestAttributeModificationException.class);
	...
	/**
	 * Constructor for TestAttributeModificationException.
	 * 
	 * @param arg0
	 */
	public TestAttributeModificationException(String arg0) {
		super(arg0);
	}
