...
public class TestModificationItem extends TestCase {

	static Log log = new Log(TestModificationItem.class);

	BasicAttribute attr = new BasicAttribute("id_sample", "value_sample");

	/**
	 * Constructor for TestModificationItem.
	 * 
	 * @param arg0
	 */
	public TestModificationItem(String arg0) {
		super(arg0);
	}
