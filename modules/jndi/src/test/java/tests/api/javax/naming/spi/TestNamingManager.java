...
public class TestNamingManager extends TestCase {
	...
	static Log log = new Log(TestNamingManager.class);
	 ...
	 * @param arg0
	 */
	public TestNamingManager(String arg0) {
		super(arg0);
	}
	...
	protected void setUp() throws Exception {
		...
		props1
				.put(Context.STATE_FACTORIES,
						"tests.api.javax.naming.spi.TestNamingManager$MockStateFactory");

		Hashtable env = new Hashtable();
		env
				.put(Context.STATE_FACTORIES,
						"tests.api.javax.naming.spi.TestNamingManager$MagicMockStateFactory");
	...
	private void myTestGetObjectInstance_NoBuilder_ReferenceExceptionalURL(
		...
		try {
			...
			// writeProviderResource("tests.api.javax.naming.spi.dummy",
			// ctxEnv);
			try {
				indicateNullPointerException(env);
	...
	private void myTestGetObjectInstance_NoBuilder_ReferenceExceptionalURL2(
		...
		try {
			...
			writeProviderResource("tests.api.javax.naming.spi.dummy", ctxEnv);
			try {
	...
	public void testGetStateToBind_f1ReturnNull_Success() {
		...
		h
				.put(
						...
						"tests.api.javax.naming.spi.TestNamingManager$MagicMockStateFactory"
								+ ":"
								+ "tests.api.javax.naming.spi.TestNamingManager$MagicSuccessMockStateFactory");
	...
	public void testGetURLContext_http_f1Success() {
		...
		h.put(Context.URL_PKG_PREFIXES,
				"tests.api.javax.naming.spi.mocksuccess");
	...
	public void testGetURLContext_http_f1BadClassName_f2Success() {
		...
		Hashtable h = new Hashtable();
		h.put(Context.URL_PKG_PREFIXES,
				"bad.class.name:tests.api.javax.naming.spi.mocksuccess");
	...
	public void testGetURLContext_http_f1NamingException_f2Success() {
		...
		h
				.put(Context.URL_PKG_PREFIXES,
						"tests.api.javax.naming.spi.mock:tests.api.javax.naming.spi.mocksuccess");
		indicateNamingException(h);
	...
	public void testGetURLContext_http_f1Success_f2RuntimeException() {
		...
		h
				.put(Context.URL_PKG_PREFIXES,
						"tests.api.javax.naming.spi.mocksuccess:tests.api.javax.naming.spi.mock");
		indicateRuntimeException(h);
	...
	public void testGetURLContext_http_f1ReturnNull_f2ReturnNull() {
		...
		h
				.put(Context.URL_PKG_PREFIXES,
						"tests.api.javax.naming.spi.mock:tests.api.javax.naming.spi.mock");
		indicateReturnNull(h);
	...
	public void testGetContinuationContext_OBJ_name_context_h()
		...
		h
				.put(Context.OBJECT_FACTORIES,
						"tests.api.javax.naming.spi.TestNamingManager$MockContextObjectFactory");
