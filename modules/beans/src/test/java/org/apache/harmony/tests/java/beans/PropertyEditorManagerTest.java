...
import org.apache.harmony.tests.java.beans.auxiliary.AnotherSampleProperty;
import org.apache.harmony.tests.java.beans.auxiliary.OtherEditor;
import org.apache.harmony.tests.java.beans.auxiliary.SampleProperty;
import org.apache.harmony.tests.java.beans.auxiliary.SamplePropertyEditor;
import org.apache.harmony.tests.java.beans.editors.AnotherSamplePropertyEditor;
...
public class PropertyEditorManagerTest extends TestCase {
    ...
    public void testFindEditorByDefaultLocation() {
        PropertyEditorManager.setEditorSearchPath(
                new String[] {"org.apache.harmony.tests.java.beans.editors"});
        PropertyEditor pe = PropertyEditorManager.findEditor(
