...
import org.apache.harmony.beans.tests.java.beans.beancontext.mock.MockBeanContextChildS;
...
import org.apache.harmony.beans.tests.java.beans.beancontext.mock.MockBeanContextMembershipListenerS;
import org.apache.harmony.beans.tests.java.beans.beancontext.mock.MockBeanContextProxy;
import org.apache.harmony.beans.tests.java.beans.beancontext.mock.MockBeanContextProxyS;
...
import org.apache.harmony.beans.tests.java.beans.beancontext.mock.MockVisibility;
...
public class BeanContextSupportTest extends TestCase {
	...
	public void testGetResource_NotExist() {
		...
		URL url = support.getResource(
				"org/apache/harmony/beans/tests/java/beans/beancontext/mock/nonexist", child);
		assertNull(url);
	}
