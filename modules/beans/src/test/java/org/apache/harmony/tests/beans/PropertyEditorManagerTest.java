...
import org.apache.harmony.tests.beans.auxiliary.AnotherSampleProperty;
import org.apache.harmony.tests.beans.auxiliary.OtherEditor;
import org.apache.harmony.tests.beans.auxiliary.SampleProperty;
import org.apache.harmony.tests.beans.auxiliary.SamplePropertyEditor;
import org.apache.harmony.tests.beans.editors.AnotherSamplePropertyEditor;
...
public class PropertyEditorManagerTest extends TestCase {
    ...
    public void testFindEditorByDefaultLocation() {
        PropertyEditorManager.setEditorSearchPath(
                new String[] {"org.apache.harmony.tests.beans.editors"});
        PropertyEditor pe = PropertyEditorManager.findEditor(
