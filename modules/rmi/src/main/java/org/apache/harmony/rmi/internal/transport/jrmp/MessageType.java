...
public class MessageType {
	 ...
	 */
	public final static MessageType CALL = new MessageType((byte) 0x50);

	/**
	 * A 0x52 <code>byte</code> representing a PING message
	 */
    public final static MessageType PING = new MessageType((byte) 0x52);

	/**
	 * A 0x54 <code>byte</code> representing a DGCACK message
	 */
    public final static MessageType DGCACK = new MessageType((byte) 0x54);
