...
public class CP_1251 extends Charset {
        ...
        public CP_1251(String csName, String[] aliases) {
            super(csName, aliases);
        }

        public boolean contains(Charset cs) {
            return cs.name().equalsIgnoreCase("IBM367") || cs.name().equalsIgnoreCase("US-ASCII") || cs.name().equalsIgnoreCase("windows-1251") ;
        }
